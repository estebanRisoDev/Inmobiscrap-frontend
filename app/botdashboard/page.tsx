        ...
        if (!bot.scheduleEnabled || !bot.cronExpression) {
          return (
            <Chip
              ...
              size="small"
              variant="outlined"
              sx={{ color: '#9e9e9e', borderColor: '#e0e0e0' }}
            />
          );
        }
        return (
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Typography variant="body2" sx={{ fontWeight: 600 }}>
          {(params.value || 0).toLocaleString('es-CL')}
        </Typography>
      ),
    },
    {
      field: 'lastRunCount',
      headerName: 'Último run',
      width: 100,
      headerAlign: 'center',
      align: 'center',
      renderCell: (params) => (
          ...
          <Box sx={{ display: 'flex', gap: 0.75 }}>
            ...
            {(isRunning || isStopping) && (
              <Button
                ...
                onClick={() => setStopDialog({ open: true, bot, stopping: false })}
                disabled={isStopping}
            ...
            <Button
              ...
              onClick={() => setDeleteDialog({ open: true, bot, deleting: false })}
    ...
    <Box sx={{ padding: 4, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
          ...
          <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            {user && (
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, px: 2, py: 1, bgcolor: '#f0f4ff', borderRadius: 2 }}>
                <Avatar
                  src={user.avatarUrl}
                  sx={{ width: 32, height: 32, bgcolor: '#1976d2', fontSize: '0.8rem' }}
                >
      ...
      >
        ...
        <DialogActions sx={{ p: 2, gap: 1 }}>
          <Button
            onClick={() => setStopDialog({ open: false, bot: null, stopping: false })}
      ...
      >
        ...
        <DialogActions sx={{ p: 2, gap: 1 }}>
          <Button
            onClick={() => setDeleteDialog({ open: false, bot: null, deleting: false })}
